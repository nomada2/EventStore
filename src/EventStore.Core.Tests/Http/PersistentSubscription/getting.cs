...
namespace EventStore.Core.Tests.Http.PersistentSubscription
{
    ...
    [TestFixture, Category("LongRunning")]
    class when_getting_messages_from_an_empty_subscription_returns_0_messages : with_admin_user
    {
    ...
    class when_getting_messages_from_a_subscription_with_n_messages_returns_n_messages : with_subscription_having_events
    {
        private JObject _response;
        protected override void When()
        {
