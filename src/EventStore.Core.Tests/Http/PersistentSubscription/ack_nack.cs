...
{
    class when_getting_a_message_can_ack : with_subscription_having_events
    {
    ...
    class when_getting_n_messages_can_ack_n_messages : with_subscription_having_events
    {
    ...
    class when_getting_a_message_can_nack : with_subscription_having_events
    {
    ...
    class when_getting_n_messages_can_nack_n_messages : with_subscription_having_events
    {
        private HttpWebResponse _response;
        protected override void When()
        {
